...
String apiKey = "TGZGO7OMDDUW2K90";
...
// IF WE POWER The Pulse Sensor AT VOLTAGE LESS THAN THE BOARD VOLTAGE,
 
// WE MUST UN-COMMENT THE NEXT LINE AND APPLY THAT VOLTAGE TO THE A-REF PIN
...
delay(1000);
ser.print(getStr);
Serial.println(getStr); //thingspeak needs delay between updates
delay(3000);
}
void read_temp()
{
